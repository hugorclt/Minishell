...
8
normal! 0
lcd ~/Desktop/FT_42/Minishell
wincmd w
argglobal
if bufexists("~/Desktop/FT_42/Minishell/srcs") | buffer ~/Desktop/FT_42/Minishell/srcs | else | edit ~/Desktop/FT_42/Minishell/srcs | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer>  <Plug>NetrwHideEdit
nmap <buffer> <nowait> <silent>  <Plug>NetrwRefresh
