...
/*   Updated: 2022/05/19 11:49:04 by hrecolet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_exit_choice(t_node *params, t_list **lst, char **cmd)
{
	if (cmd[1])
		ft_exit(params, lst, ft_atoi(cmd[1]));
	else
		ft_exit(params, lst, errno);
	return (0);
}